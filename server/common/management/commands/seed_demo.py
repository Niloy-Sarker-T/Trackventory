...
class Command(BaseCommand): 
    def handle(self, *args, **kwargs):
        ...
        if Product.objects.exists():
            self.stdout.write(self.style.WARNING("Sqlite is already working with stablity  already exists."))
            return

        create_demo_data()
        self.stdout.write(self.style.SUCCESS("Sqlite started working succesfully."))
