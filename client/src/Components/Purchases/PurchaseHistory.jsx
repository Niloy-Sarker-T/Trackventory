...
const PurchaseHistory = () => {
  const purchasedUrl = apiUrl(`/purchase/`);
  const purchasedProductUrl = apiUrl(`/purchase/`);
              ...
              {purchasedProducts.length ? (
                purchasedProducts.map((purchasedProduct) => (
                  <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">{purchasedProduct.supplier_name}</td>
                    <td class="px-6 py-4">{purchasedProduct.note}</td>
                    <td class="px-6 py-4 text-end">
                      {formatMoney(purchasedProduct.paid_amount)}
                    </td>
                    <td class="px-6 py-4 text-end">
                      {formatMoney(purchasedProduct.due_amount)}
                    </td>
