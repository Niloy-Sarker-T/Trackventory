...
const PurchasePaymentModal = (props) => {
    ...
    return (
        <>
            {/* <!-- Main modal --> */}
            <div id="purchasePaymentModal" tabIndex="-1" aria-hidden="true" className="fixed top-0 left-0 right-0 z-50 flex h-full w-full items-center justify-center bg-slate-950/40 p-4">
                <div className="p-2 relative w-full h-full max-w-2xl md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                            ...
                            <button type="button" onClick={props.onClose} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
